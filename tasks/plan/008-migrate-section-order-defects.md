...
| 8 | ~~TASK-360~~ 구분 공백줄의 CRLF 보존 | P3 | 완료 2026-09-10. 합성 separator도 CRLF 입력에서 `\r\n`으로 렌더링하고, LF 회귀와 수정 전 overlay 실패를 함께 고정했다 |
...
- ~~TASK-360~~ — 구분 공백줄의 CRLF 보존 (done, 2026-09-10; CRLF/LF 회귀와 수정 전 overlay 실패 고정)
