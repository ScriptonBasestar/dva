...
verification-summary: |
  Scoped six dispositioned: ISSUE-002 left done (archived, batch 1 staged move);
  TASK-341/352/355 carry quality-review:pass; TASK-369 pass; TASK-372 conditional.
  No waived or failed outcomes among scoped, so the evidence/routing criteria hold
  vacuously. make doc-check exit 0 (batch run).
