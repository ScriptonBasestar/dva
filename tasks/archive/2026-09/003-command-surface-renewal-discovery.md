...
| Workstream | 판정 | 작업 |
| --- | --- | --- |
| help group과 discovery 설명 | 기존 contract 안에서 개선 완료 | [TASK-253](253-align-help-groups-and-discovery-descriptions.md) |
...
| imported plan 실행 | advertised contract 복구 완료 | [TASK-262](262-restore-imported-plan-execution.md) |
| imported interaction/provision 실행 | owner 복구 완료 | [TASK-264](264-restore-imported-command-ownership.md) |
...
일부는 `tasks/archive/done/`에 있어 `tasks/todo`·`tasks/done`만 보면 존재하지 않는 것처럼 읽힌다.
...
**완료 (2026-09-07):** 위 child 14장 전부 닫혔다 (`tasks/done/` 또는 `tasks/archive/`).
