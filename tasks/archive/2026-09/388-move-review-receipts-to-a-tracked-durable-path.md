...
verification-summary: "Re-verified 2026-09-17. No tmp/ receipt pointers repo-wide; 12 archive pointers target tasks/done/evidence/; evidence-sha256 spot-check (TASK-197) matches bytes; ce task validate --all green (54 valid 0 invalid, ex-344/371 archived by siblings); criterion text updated 2-invalid to 0-invalid accordingly."
created: 2026-09-14
...
- [x] `tmp/`가 없는 체크아웃에서 validate 실패가 6에서 0으로 줄었다 — 남은 2건이던 TASK-344·371은 후속 배치에서 receipt를 해소하고 아카이브됐다 | verify: `ce task validate --all`
