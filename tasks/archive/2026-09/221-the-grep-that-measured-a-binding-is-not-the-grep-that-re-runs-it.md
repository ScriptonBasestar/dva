...
quality-review-receipt: tasks/done/evidence/TASK-221/done-review-d6795bb32f3620661dc0193b89b3a9c5b40de1a5a195af37940439f02ce70f03.json
...
[TASK-199](../archive/199-three-archived-bindings-cannot-produce-the-result-recorded-beside-them.md),
...
not — but "only ordering" is itself too weak: at `archive/022:64` the ordering
...
`tasks/archive/025-advanced-md-precedence-omits-os.md:65`:
...
- **Under the agent's grep** it matches `tasks/archive/025-…md-42-…`, its own
...
`tasks/archive/067-version-field-rule-stated-three-incompatible-ways.md:148`
...
- Whether the convention should be an absolute path per tool or a documented
  ...
  change, and since [TASK-199](../archive/199-three-archived-bindings-cannot-produce-the-result-recorded-beside-them.md)
