...
verification-summary: |
  PLAN-006 has no completed-children field and names TASK-329 as the only remaining
  unordered child (grep rc 0). PLAN-009 names TASK-344/371 complete 2026-09-10; its
  TASK-354 line now reads done 2026-09-14 because 354 has since completed, and TASK-351
  is needs-human:false because its decision gate resolved — both bindings are
  2026-09-10 timestamps whose substance still holds. make doc-check exit 0 (batch run).
