...
verification-summary: "Verified TASK-284 supersession note in PLAN-002 (updated path to tasks/archive/2026-09/)."
---
...
- [x] PLAN-002에 245 §7-4/§8-5 → 284 supersession 노트가 TASK-281 노트와 같은 형식으로 있다 | verify: `/usr/bin/grep -Eq 'TASK-284.*(supersed|대체|우선)' tasks/archive/2026-09/002-command-surface-delivery.md`
