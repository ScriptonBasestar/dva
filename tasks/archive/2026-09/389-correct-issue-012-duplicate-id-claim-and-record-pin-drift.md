...
verification-summary: "Re-verified 2026-09-17. checkDuplicateCardIDs recorded in ISSUE-012; Resolution Criteria demands issuance rule plus rename procedure (no existence-check fix); ISSUE-010 cited; ISSUE-001 records plain-pin drift (binding retargeted from dropped sha token to surviving plain-pin section after TASK-396 compression)."
created: 2026-09-14
...
- [x] ISSUE-001이 pin 드리프트 실측 두 건을 기록한다 | verify: `/usr/bin/grep -rq --include='001-*.md' 'plain 핀의 운명' tasks`
