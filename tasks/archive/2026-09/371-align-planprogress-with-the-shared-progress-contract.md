...
verification-summary: |
  go test ./tools/planprogress exit 0 (truncation table 15/16=93, 16/26=61,
  7/19=36, 2/3=66, 0/0=0 pins truncation over rounding); ce task validate --all
  86 valid/0 invalid; ce task gate READY (validate/lint/preflight pass);
