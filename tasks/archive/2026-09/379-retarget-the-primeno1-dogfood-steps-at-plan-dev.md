...
verification-summary: |
  grep bindings rc 0: 'up dev' and 'down dev --purge' present in dogfood-run.sh,
  stale external-db wording gone; --plan primeno1 rc 0 shows up dev; make doc-check
  and make lint exit 0 (batch run).
