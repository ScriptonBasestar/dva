...
verification-summary: "Re-verified 2026-09-17. Backticked bindings intact after sibling archival of 319/321: grep counts 1 and 2 under tasks/ (scope widened tasks/done/ to tasks/ in-card); ce task validate on the pair reports 2 valid 0 invalid."
created: 2026-09-14
...
quality-review-receipt: tasks/done/evidence/TASK-386/done-review-f06023034a98e896cfed52b60acd91504cf56e44381e12b575bb793c311dc9ba.json
---
...
- [x] TASK-319의 verify 값 한 줄이 백틱으로 감싸여 있다 | verify: `test "$(/usr/bin/grep -rc --include='319-*.md' 'verify: .go test' tasks/ | cut -d: -f2)" = 1`
- [x] TASK-321의 verify 값 **둘 다** 백틱으로 감싸여 있다 | verify: `test "$(/usr/bin/grep -rc --include='321-*.md' 'verify: .go ' tasks/ | cut -d: -f2)" = 2`
