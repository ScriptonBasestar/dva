...
resolution-summary: "Resolved as fixed by TASK-406."
---
...
결함은 봉인이 아니라 정정 경로의 부재로 규정된다 — 기준 1(절차 문서화)과 2(TASK-376
증거 정정) 모두 이 저장소 안에서 닫는다. digest의 정본이 상류에 있어도 여기서 쓰는
값은 validator 출력에서 얻는 로컬 관행이다([[ISSUE-001]] 선례).
