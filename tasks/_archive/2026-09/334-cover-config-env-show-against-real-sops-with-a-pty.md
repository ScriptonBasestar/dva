...
quality-review-evidence: "Independent TASK-367 review: recorded fake-driven ceiling, explicit Linux exclusion, and named tests match the accepted decision."
archived-at: 2026-09-17
verified-at: 2026-09-17
verification-summary: "Decision recorded; ceiling tests exist in config_env_show_test.go & config_env_test.go; TASK-282 criterion verified."
created: 2026-09-07
...
- [x] TASK-282's real-sops criterion no longer claims coverage `show` does not have | verify: `/usr/bin/grep -q 'seal only; show is TASK-334' tasks/archive/2026-09/282-implement-gated-env-bridge-commands.md`
