...
verification-summary: |
  PLAN-007 ownership table 5 rows, PLAN-008 '리뷰됐다는 뜻이 아니다' sentence, and
  TASK-381 '둘 다 잡지 못한다' record all grep rc 0; PLAN-006 handoff sentence
  explicitly scopes to §Order (human-read); make doc-check exit 0 (batch run).
