...
quality-review-receipt: tasks/done/evidence/TASK-214/done-review-a12c164d1451e5ea1ee2761a251bcf9632dde2e90bde24b2db971871c6bd15ba.json
...
- `tasks/archive/213-an-empty-inline-flag-value-is-accepted-and-widens-the-run-the-way-a-missing-one-used-to.md` — the card whose review measured this, under "What this card does not close"
- `tasks/archive/211-a-stack-flag-missing-its-value-is-dropped-and-the-command-runs-as-if-unwritten.md` — the original shape: a narrowing flag whose failure is indistinguishable from success
