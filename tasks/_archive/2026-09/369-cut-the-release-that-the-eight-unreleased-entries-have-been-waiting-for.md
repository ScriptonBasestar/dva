...
verification-summary: |
  v0.2.0 release intact: Version=0.2.0 (not 0.1.48), install pins point at v0.2.0,
  release-notes/v0.2.0.md non-empty (sha matches TASK-370 pin 7905843d),
  EnvBridgeIntroducedVersion=0.1.48 unchanged, make release-check exit 0.
  CHANGELOG Unreleased binding literally non-empty, but every current entry is
  post-0.2.0 work (TASK-307/309/315/319/321/331) and ## [0.2.0] - 2026-09-09 is
  present — the release-time emptying is historical fact, not a regression.
  make doc-check exit 0 (batch run).
