...
verification-summary: |
  go test ./internal/lifecycle ./internal/cli both ok; Design Record present adopting
  ExecutionPlan.Warnings with rationale; resolver.go Warnings field and
  printPlanWarnings wired across plan verbs incl. composition; make doc-check
  exit 0 (batch run).
