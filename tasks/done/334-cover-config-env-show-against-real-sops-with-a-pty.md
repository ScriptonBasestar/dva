...
- [x] TASK-282's real-sops criterion no longer claims coverage `show` does not have | verify: `/usr/bin/grep -q 'seal only; show is TASK-334' tasks/archive/done/282-implement-gated-env-bridge-commands.md`
