...
CI step 문법을 확인해 완료했다. TASK-418은 사용자 승인 뒤 [v0.3.0](https://github.com/ScriptonBasestar/dva/releases/tag/v0.3.0)을
공개했고, postflight가 원격 identity·7개 자산·checksum을 검증했다. PLAN-010의 8개 작업이 완료됐다.
