...
// a card moves from tasks/todo/ to tasks/done/ or tasks/archive/ (directly, or nested
// under tasks/archive/done/) and the plan keeps reporting the old numbers until a human
...
// completed-tasks when a child moves to done/archive. The two do not make each other
