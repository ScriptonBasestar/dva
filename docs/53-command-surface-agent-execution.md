...
이 문서는 [PLAN-002](../tasks/archive/2026-09/002-command-surface-delivery.md)를 새 Codex 세션에서
...
| Wave | Task | 세션 종료 조건 |
| --- | --- | --- |
| 완료 | [TASK-245](../tasks/archive/2026-09/245-freeze-env-bridge-contract.md) | Option A 결정 승인 완료 |
| 완료 | [TASK-247](../tasks/archive/2026-09/247-freeze-required-env-command-policy.md) | 결정·검증·통합 완료 |
| 1 | [TASK-249](../tasks/archive/2026-09/249-redesign-capability-driven-init.md) | init contract 사용자 결정이 기록·검증됨 |
| 1 | [TASK-244](../tasks/archive/2026-09/244-validate-plan-declaration-drift.md) | D6/D7 구현·독립 review·통합 완료 |
| 완료 | [TASK-264](../tasks/archive/2026-09/264-restore-imported-command-ownership.md) | owner 복구·통합 완료 |
| 완료 | [TASK-265](../tasks/archive/2026-09/265-decide-interaction-env-file-contract.md) | env_file 결정 승인 완료 |
| 1 | [TASK-266](../tasks/archive/2026-09/266-deprecate-and-reject-interaction-env-file.md) | TASK-265 결정 구현 |
| 2 | [TASK-248](../tasks/archive/2026-09/248-enforce-required-env-command-policy.md) | TASK-247·264·265 위에서 loader safety 구현·통합 완료 |
| 2 | [TASK-250](../tasks/archive/2026-09/250-implement-capability-driven-init.md) | TASK-244·249 결과 구현·통합 완료 |
| 3 | [TASK-246](../tasks/archive/2026-09/246-implement-secure-config-env-bridge.md) | TASK-245 결정·TASK-248 contract 위에서 구현·통합 완료 |
| 4 | [TASK-252](../tasks/archive/2026-09/252-decide-top-level-env-promotion.md) | 영구 유지 결정 또는 promotion evidence 요청이 기록됨 |
| 조건부 | [TASK-251](../tasks/archive/2026-09/251-build-env-migration-evidence-gate.md) | TASK-252가 요청한 경우 gate 통합, 아니면 N/A 종료 |
| 조건부 재개 | [TASK-252](../tasks/archive/2026-09/252-decide-top-level-env-promotion.md) | TASK-251 evidence를 사용한 최종 결정 기록 |
...
세부 계약은 [PLAN-002 §4](../tasks/archive/2026-09/002-command-surface-delivery.md#4-env-bridge의-비협상-수용-조건),
[§5](../tasks/archive/2026-09/002-command-surface-delivery.md#5-promotion-evidence-contract)와 target task card가 소유한다.
...
PLAN: tasks/archive/2026-09/002-command-surface-delivery.md
